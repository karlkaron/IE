...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,0){\includegraphics[scale=0.55]{europa1}}} % Image background
\centering
\vspace*{5cm}
\par\normalfont\fontsize{35}{35}\sffamily\selectfont
\textbf{ISTORIA EUROPEI}\\
{\LARGE Notite de curs}\par % Book title
\vspace*{1cm}
...
\noindent \textsc{Universitatea de Stat "Alecu Russo` din Balti}\\

\noindent \textsc{www.usrarb.md}\\ % URL

\noindent Un digest a literaturii necesare pentru curs\\ % License information
